const formValidator = function (formSelector = 'form') {
  /* ----------------------------
  ...
  const inputs = form.querySelectorAll('input.need-validation');
  ...
  //var usernameInput = form.getElementById('username');
  //var passwordInput = form.getElementById('password');
